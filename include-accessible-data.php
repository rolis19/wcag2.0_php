<?php
echo '<script src="js/accessible-data/tag-ol.js"></script>';
echo '<script src="js/accessible-data/tag-img.js"></script>';
echo '<script src="js/accessible-data/tag-input.js"></script>';
echo '<script src="js/accessible-data/check-lang.js"></script>';
echo '<script src="js/accessible-data/check-id.js"></script>';
echo '<script src="js/accessible-data/check-icon.js"></script>';
